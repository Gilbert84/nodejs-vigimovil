        ...
        .exec(
            (err, asignaciones) => {
                ...
                Asignacion.populate(asignaciones, [{ path: 'operario.empresa vehiculo.empresa', select: 'nombre img', model: 'Empresa' },
                                                  { path: 'terminal.tipo', select: 'nombre', model: 'TipoMarcador' }],
                    (error, asignaciones) => {
    ...
    Asignacion.findById(id)
        ...
        .exec((err, asignacion) => {
            ...
            Asignacion.populate(asignacion, [
                    ...
                    { path: 'vehiculo.dispositivo', select: 'socket_id disponible', model: 'Dispositivo' }
                ],
                (error, tipo) => {
                    res.status(200).json({
                        ok: true,
...
app.put('/:id', mdAutenticacion.verificaToken, (req, res) => {
    ...
    Asignacion.findById(id, (err, asignacion) => {
        ...
        asignacion.terminal = body.terminal;
