...
app.post('/server', (req, res) => {
    ...
    Usuario.findOne({ email: body.email }, (err, usuarioDB) => {
        ...
        var token = jwt.sign({ usuario: usuarioDB }, SEED, { expiresIn: 300 }); // 5 minutos
...
function obtenerMenu(ROLE) {
    ...
    var menu = [{
        ...
        //         { titulo: 'Empresas', url: '/hospitales' },
        //         { titulo: 'Operarios', url: '/medicos' }
        //     ]
        // }
    ];
        ...
        case 'ADMINISTRADOR':
            menu.push({
                ...
                submenu: [
                    ...
                    {   titulo: 'Despacho', url: '/modulo-despacho' },
                    {   titulo: 'Monitoero', url: '/modulo-monitoreo' }
                ]
            });        
            break;
        case 'COORDINADOR':
