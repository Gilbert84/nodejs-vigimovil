...
io.on('connection', (socket) => {
    ...
    socket.on('dispositivoConectado', (dispositivo, callback) => {
        ...
        //socket.broadcast.emit('listaActualDispositivos', dispositivos.agregar(dispositivo));
        console.log('log:73 dispositivo disponible:',dispositivo.socket_id,new Date());
        database.actualizar(dispositivo).then((resp) =>{
            console.log('log:76 resp',resp);
            return callback(resp);
        });
        //     let dispositivosActuales = dispositivos.agregar(dispositivo);
        //     console.log('log:74 dispositivosActuales',dispositivosActuales);
    ...
    socket.on('disconnect', function() {
        ...
        //     console.log('log:265 dispositivo no disponible :',dispositivoBorrado.socket_id);
        //     // database.actualizar(dispositivoBorrado).then((resp) => {
        //     //     console.log('log:263 dispositivo no disponible',resp);
        //     // });
